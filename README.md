...
- A relational database is a collection of tables and data stored on a server. SQL or structured query language is a way to communicate with the database.
